...
public class EtudiantForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String Niveau = jTextField5.getText();
        ...
        if(Matricule == null || Matricule.trim().equals("")){
         ...
         if(Filiere == null || Filiere.trim().equals("")){
            JOptionPane.showMessageDialog(null, "Veuillez remplir la filiere");
            return;
        }
         if(Niveau == null || Niveau.trim().equals("")){
            JOptionPane.showMessageDialog(null, "Veuillez remplir le niveau");
            return;
        } 
          if(Password == null || Password.trim().equals("")){
            JOptionPane.showMessageDialog(null, "Veuillez remplir le password");
            return;
        }
         
         
        
        String resp = te.addEtudiant(Matricule, Prenom, Nom, Filiere, Niveau, Password);
        if(resp.equals("ok")){
            JOptionPane.showMessageDialog(null, "Insertion réussie");
        }
        else if(resp.equals("already_exist")){
            JOptionPane.showMessageDialog(null, "Matricule exist");
        }
        else{
            JOptionPane.showMessageDialog(null, "Insertion echouee");
        }
